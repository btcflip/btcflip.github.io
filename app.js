...
if(document.getElementById("betTargetSpan").innerHTML == "LO") { cond = "<"; }
  ...
  _redirect: function(url) {
	  console.log(url);
	  if(url !== "/pyrambit" && url !== "/dice" && url !== "/coinflip")
	document.location.href = "http://bitsino.xyz"+url;
  ...
  render: function() {
    ...
    return el.div(
	  ...
	  type: 'button',
	  onClick: function(){document.location.href = "http://bitsino.xyz/dice"}},
	  'Dice'
	  ),
	  el.button(
	  {className:'rollButton2',
	  type: 'button',
	  onClick: function(){document.location.href = "http://bitsino.xyz/coinflip"}},
	  'Coinflip'
	  ),
	  el.button(
	  {className:'rollButton3',
	  type: 'button',
	  onClick: function(){document.location.href = "http://bitsino.xyz/pyrambit"}},
	  'Pyramid'
	  )
